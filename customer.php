                  ...
                  <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome, 
                   ...
                   echo "<i class='fa fa-user-circle' aria-hidden='true'></i>" . "  " . "  " . $_SESSION['worker_name'];
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="myaccount.php" class="dropdown-item">My profile</a></li>
                      <li><a href="https://www.tutorialrepublic.com/codelab.php?topic=bootstrap&file=dropdowns-within-navbar" class="dropdown-item">Notification</a></li>
